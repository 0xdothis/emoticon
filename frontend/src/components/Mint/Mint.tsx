  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between">
       ...
       <div className="max-w-[678px] space-y-8">
         ...
         <p className="font-dyna text-[1.25rem] tracking-wider leading-8 md:leading-10">Your Emoticon is waiting unique, expressive, and forever yours on the blockchain.</p>
        <p className="font-dyna text-[1.25rem] tracking-wider leading-8 md:leading-10">Join the wave of emoticon spreading through the metaverse.  Minting an Emoticon means owning a piece of digital feeling, no duplicates, no copies. Just pure expression, recorded forever.</p>
